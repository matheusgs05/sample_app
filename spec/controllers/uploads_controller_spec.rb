...
describe UploadsController do
  ...
  let(:valid_attributes) { { "arquivo" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved upload as @upload" do
        ...
        post :create, {:upload => { "arquivo" => "invalid value" }}, valid_session
        assigns(:upload).should be_a_new(Upload)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested upload" do
        ...
        Upload.any_instance.should_receive(:update).with({ "arquivo" => "MyString" })
        put :update, {:id => upload.to_param, :upload => { "arquivo" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the upload as @upload" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Upload.any_instance.stub(:save).and_return(false)
        put :update, {:id => upload.to_param, :upload => { "arquivo" => "invalid value" }}, valid_session
        assigns(:upload).should eq(upload)
      end
